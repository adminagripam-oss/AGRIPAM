...
if "function openEditKebunModal" not in content:
    target_str = "    function filterTKPanenTable() {"
    content = content.replace(target_str, js_code + "\n" + target_str)

with open(file_path, 'w', encoding='utf-8') as f:
    f.write(content)

print("SUCCESSFULLY ADDED openEditKebunModal AND MONTH SELECTOR JS FUNCTIONS!")
